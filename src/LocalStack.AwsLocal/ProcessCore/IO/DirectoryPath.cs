...
*    Author: Mattias Karlsson, Patrik Svensson, Gary Ewan Park, Joseph Musser, Erik Schierboom
*    Date: 01.05.2020
*    Code version: commit: 0c46856abe976f6c122f05a5e82ccb854fd923c1
*    Availability: https://github.com/cake-build/cake/blob/develop/src/Cake.Core/IO/DirectoryPath.cs
*
***************************************************************************************/
...
namespace LocalStack.AwsLocal.ProcessCore.IO
{
    ...
    public sealed class DirectoryPath : Path
    {
        ...
        public DirectoryPath MakeAbsolute(DirectoryPath path)
        {
            ...
            if (path.IsRelative)
            {
                throw new Exception("The provided path cannot be relative.");
            }
            return IsRelative
